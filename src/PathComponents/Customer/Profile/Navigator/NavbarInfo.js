...
export default function Navbar(props) {
    ...
    const LinkToPoint=`/${props.value}/Point`;
    return (
        <div className='card offset-md-2 col-md-2'>
            <div className="list-group">
                <ul className="navbar-nav">
                    ...
                    <li><Link to={`/${props.value}/Profile/Point`} className="list-group-item list-group-item-action">
                    ...
                    <li><Link to={`/${props.value}/Profile/CreditCard`} className="list-group-item list-group-item-action">
                    ...
                    <hr></hr>
                    <a href={`https://voucher.votuan.xyz/user/home/?token=${props.value}&appId=vy04`} className="list-group-item list-group-item-action">
                    ...
                    <li><Link to={`/${props.value}/Profile/`} className="list-group-item list-group-item-action">
